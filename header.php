...
<head>
  ...
  <title>High Drone MX</title>

  <!-- High Drone Icon -->
  <link rel="icon" href="img/HIGHDRONE_LOGO.png">
  ...
  <nav class="navbar navbar-expand-lg navbar-light fixed-top py-3" id="mainNav">
    <div class="container">
      <a class="navbar-brand js-scroll-trigger" href="#page-top">
        <img src="img/mexFlagIco32PX.png" alt="mexFlagIco">
        HIGH DRONE MX
      </a>
      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav ml-auto my-2 my-lg-0">
          ...
          <li class="nav-item">
            <a class="nav-link js-scroll-trigger" href="#portfolio">Nuestros Proyectos</a>
          </li>
          <li class="nav-item">
